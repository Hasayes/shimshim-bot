...
CLASSIFY_SYSTEM = (
    ...
    "targeting, bidding or in talks, attributed to a journalist or the "
    "clubs. Opinion and fan content — 'should sign', 'would be perfect "
    "for', 'dream target', pundit suggestions — is NOT interest. A story "
    "about a watched club setting an asking price for its OWN player is "
    "NOT interest (the buyer matters, not the seller). The watched clubs, "
...
BRIEF_SYSTEM = (
    ...
    "research notes — never a passing mention, however famous. "
